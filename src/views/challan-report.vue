                ...
                <div class="flex justify-start items-center gap-x-4 w-full">
                  ...
                  <div class="w-1/4">
                    ...
                    <Dropdown
                        ...
                        :options="cities"
                        class="w-full py-[4px] mt-[10px] placeholder:text-primaryText placeholder:leading-[16px] placeholder:text-[12px] xl:placeholder:leading-[20px] xl:placeholder:text-[14px]"
                        optionLabel="name" placeholder="Select trip/coach no"/>
                  </div>
                  <div class="w-1/4">
              ...
              <table class="min-w-full">
                ...
                <tbody>
                    <tr class="border-b border-[#EDEDED]">
                        ...
                        <td class="leading-[16px] text-[12px] xl:leading-[20px] xl:text-[14px] font-[400] text-center border-r border-[#DBDBDB] text-primaryText py-3 underline">
                            Full Challan
                        </td>
                    </tr>
