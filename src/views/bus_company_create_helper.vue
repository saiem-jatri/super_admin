          ...
          <div class="flex justify-center items-center gap-x-[32px]">
            ...
            <div class="flex flex-col gap-y-[4px]">
              ...
              <div class="flex justify-center items-center gap-x-[6px]">
                ...
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">Helper</p>
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">Add helper</p>
              </div>
            </div>
          </div>
        ...
        <div class="mt-[16px] bg-white rounded-[10px]">
          <div class="p-4">
            <div class="flex justify-center items-center gap-x-[10px] xl:gap-x-[16px]">
              <div class="w-1/4">
                <p class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[600]">Helper name</p>
                <input type="text" class="createNormalInput" placeholder="Enter driver name">
              </div>
              <div class="w-1/4">
          ...
          <div class="px-[16px] py-[20px] w-full flex justify-between items-center">
            ...
            <button class="flex justify-center items-center text-white leading-[16px] text-[12px] xl:leading-[20px] xl:text-[14px] font-[600] bg-corporate bg-opacity-30 rounded-full px-[20px] py-[11px] xl:px-[24px] xl:py-[13px]">Create helper</button>
          </div>
        </div>
      </div>
    </div>
