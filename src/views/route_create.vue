              ...
              <div class="w-1/2 pr-[60px] xl:pr-[125px]">
                <div class="flex justify-between items-center">
                  ...
                  <div class="w-[200px] xl:w-[270px]">
                    <Dropdown v-model="selectedCity" :options="cities"
                              class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" optionLabel="name" placeholder="Select operator"/>
                  </div>
                </div>
                <div class="flex justify-between items-center mt-[12px] xl:mt-[8px]">
                  ...
                  <div class="w-[200px] xl:w-[270px] mb-2">
                    <Dropdown v-model="selectedCity" :options="cities"
                              class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" optionLabel="name" placeholder="Select origin city"/>
                  </div>
                </div>
                <button
                    class="w-full border border-dashed border-corporateSecondaryBlue flex justify-center items-center bg-[#EFF7FD] rounded-[4px] mt-[12px] xl:mt-[10px]">
                ...
                <div class="flex justify-between items-center mt-[12px] xl:mt-[8px]">
                  ...
                  <div class="w-[200px] xl:w-[270px] mb-2">
                    <Dropdown v-model="selectedCity" :options="cities"
                              class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" optionLabel="name" placeholder="Select destination city"/>
                  </div>
                </div>
