    ...
    <div class="h-screen w-full overflow-y-auto bg-[#F7F7F7]">
      ...
      <div class="px-[30px] py-[24px]">
        ...
        <div class="bg-white rounded-[8px]">
          <div class="p-4">
            ...
            <div class="flex justify-between items-center">
              <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500] mt-2">PERMISSIONS & COMMISSIONS</p>
              <p class="flex gap-x-[10px]">
                <img src="../assets/svg/back_arrow.svg" alt="">
                <a href="#" class="leading-[12px] xl:leading-[16px] text-[10px] xl:text-[12px] text-primaryText border-b-2 border-primaryText block text-primaryText font-[600]">Prev .step</a>
              </p>
            </div>
          </div>
        </div>
        <div class="bg-white rounded-[8px] mt-[12px] xl:mt-[16px]">
          <div class="p-4">
            <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500] mb-4">TRIP PERMISSION</p>
            <div class="flex justify-center items-center gap-x-[10px] xl:gap-x-[16px]">
              <div class="w-1/4">
                ...
                <div class="py-[8px] border border-corporateBorder rounded-[4px] mt-[10px]">
                  <div class="w-full  rounded-[4px] flex justify-between items-center divide-x divide-corporateBorder">
                    <input type="text" class="w-[80%] focus:outline-none px-[8px] placeholderDesign" placeholder="Enter trip available time">
                    <p class="w-[20%] text-center leading-[16px] xl:leading-[20px] text-[12px] xl:text-[14px] text-corporateSecondaryBlack">hr</p>
                  </div>
                </div>
              </div>
              ...
              <div class="w-1/4">
                ...
                <input type="text" class="createNormalInput" placeholder="Enter bus reg. no">
              </div>
              <div class="w-1/4">
          ...
          <div class="p-4">
            <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500] mb-4">ROUTE PERMISSION</p>
            <div class="flex justify-center items-center gap-x-[10px] xl:gap-x-[16px]">
              <div class="w-1/4">
          ...
          <hr class="mt-[12px] xl:mt-[16px] border-t border-corporateBorder">
          <div class="p-4">
            <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500] mb-4">COMMISSION</p>
              ...
              <div class="w-1/4">
                ...
                <div class="py-[2px] border border-[#DBDBDB] mt-[10px] rounded-[4px] leading-[20px]">
                  <div class="w-full h-[35px] flex justify-between items-center overflow-hidden divide-x" >
                    <input class="p-4 text-[#676769] leading-[20px] text-[14px] font-[400] w-2/5 placeholder:text-primaryText focus:outline-none" placeholder="Enter ammount">
                    <div class="p-2 w-3/5 ">
          ...
          <hr class="mt-[12px] xl:mt-[16px] border-t border-corporateBorder">
          <div class="p-4">
            <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500] mb-4">PUBLISH FOR JATRI</p>
            <div class="flex justify-start items-center gap-x-[10px] xl:gap-x-[16px]">
              <div class="w-1/4">
        ...
        <div class="flex justify-center items-center mt-5">
          <button class="bg-corporate bg-opacity-30 flex gap-x-3 justify-center items-center text-white rounded-full px-5 py-3 mr-4 leading-[12px] text-[10px] xl:leading-[16px] xl:text-[12px]">Next step<span><img src="../assets/svg/right-white-arrow.svg" class="h-[9.33px] w-[9.33px]" alt=""></span></button>
        </div>
      </div>
    </div>
  </div>
