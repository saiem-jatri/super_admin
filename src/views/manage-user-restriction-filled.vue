        ...
        <div class="p-4 flex justify-between items-center gap-x-[30px]">
          <div class="flex justify-start items-center gap-x-4 w-full">
            <div class="w-1/2 relative">
              ...
              <Dropdown class="w-full py-[2px] mt-[10px] placeholder:text-primaryText placeholder:leading-[16px] placeholder:text-[12px] xl:placeholder:leading-[20px] xl:placeholder:text-[14px]" v-model="selectedCity" :options="cities" optionLabel="name" placeholder="" />
              <div class="flex gap-x-2 absolute top-[37px] left-2 xl:top-10">
                <p class="bg-[#1E88E5] text-white rounded py-1 px-[6px] text-[12px] xl:text-sm inline-block">Trip heading</p>
                <p class="bg-[#1E88E5] text-white rounded py-1 px-[6px] text-[12px] xl:text-sm inline-block">+2</p>
              </div>
            </div>
            <div class="w-1/4">
