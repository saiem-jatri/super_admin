        ...
        <div class="mt-[16px] bg-white">
            <div class="p-4 flex justify-between items-center">
              <div class="flex justify-start items-center gap-x-4 w-full">
                <div class="w-1/5">
                  <p class="text-primaryText leading-[24px] text-[16px] font-[600]">User type</p>
                ...
                <div class="w-1/5">
                  <div class="flex justify-between items-center w-full">
                    <p class="text-primaryText leading-[24px] text-[16px] font-[600]">Name</p>
                  </div>
                ...
                <div class="w-1/5">
                  <div class="flex justify-between items-center w-full">
                    <p class="text-primaryText leading-[24px] text-[16px] font-[600]">Mobile number</p>
                  </div>
                  <input type="text" class="focus:outline-none mt-[10px] w-full border border-[#DBDBDB] rounded-[4px] pl-2 py-2 placeholder:text-[#676769] placeholder:leading-[20px] placeholder:text-[14px]" placeholder="Enter company name">
                </div>
              </div>
              <button class="flex gap-x-[9px] justify-center items-center bg-corporate text-white font-[500] py-3 pl-[17px] pr-[24px] rounded-full"><span>
                <img src="../assets/svg/white_search.svg" class="w-[20px] h-[20px]" alt="">
              </span>Search</button>
            </div>
        </div>
        <div class="bg-white rounded-[8px] mt-4">
          ...
          <table class="min-w-full">
            ...
            <tr class="border-b border-[#EDEDED]">
              ...
              <td class="text-primaryText border-r border-[#DBDBDB] text-center">
                Fahim Ahmed
              </td>
