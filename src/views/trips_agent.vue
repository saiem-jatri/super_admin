        ...
        <div class="bg-white rounded-[8px]">
          <div class="p-4">
            ...
            <div class="flex justify-between items-center">
              <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500] mt-2">ASSIGN COUNTERMAN & AGENT</p>
          ...
          <div class="p-4">
            <div class="flex justify-between items-center">
              ...
              <div class="form-group">
                ...
                <label for="html" class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[600]">Mark all</label>
              </div>
            </div>
            <div class="p-2">
              <div class="flex items-center justify-between">
              <div class="w-[25%]">
                <p class="leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] text-corporateSecondaryBlack">Counter 1</p>
                ...
                <div class="flex w-[75%] flex-col divide-y divide-dashed">
                  <div class="flex gap-x-[18px] py-2">
                    <div class="form-group w-[238px]">
                      <input type="checkbox" id="html">
                      <label for="html" class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[400]">Fahim Ahmed</label>
                    </div>
                    <div class="form-group w-[238px]">
                      <input type="checkbox" id="html">
                      <label for="html" class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[400]">Fahim Ahmed</label>
              ...
              <div class="flex items-center justify-between">
                <div class="w-[25%]">
                  <p class="leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] text-corporateSecondaryBlack">Counter 2</p>
                  <div class="form-group mt-2">
                    <input type="checkbox" id="html">
                    <label for="html" class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[600]">Mark all</label>
                  </div>
              ...
              <div class="flex items-center justify-between">
                <div class="w-[25%]">
                  <p class="leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] text-corporateSecondaryBlack">Counter 3</p>
                  <div class="form-group mt-2">
                    <input type="checkbox" id="html">
                    <label for="html" class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[600]">Mark all</label>
                  </div>
              ...
              <div class="flex items-center justify-between">
                <div class="w-[25%] mt-4">
                  <p class="leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] text-corporateSecondaryBlack">Counter 4</p>
                  <div class="form-group mt-2">
                    <input type="checkbox" id="html">
                    <label for="html" class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[600]">Mark all</label>
                  </div>
