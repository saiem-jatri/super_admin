        ...
        <div class="flex justify-between">
          ...
          <div class="flex gap-x-[24px] p-4 w-1/2 justify-end items-center pr-2 ">
           <div
              ...
              <input
                  class="outline-none placeholder:text-[#4D4D4F] w-[90%] placeholder:text-[8px] placeholder:leading-[16px] xl:placeholder:text-[14px] xl:placeholder:leading-[20px]"
        ...
        <div class="bg-white rounded-[8px] mt-4">
          ...
          <table class="min-w-full">
            ...
            <tr class="border-b border-[#EDEDED]">
              ...
              <td class="border-r border-[#DBDBDB]">
                <div class="py-[5px] px-[18px] flex justify-center items-center gap-x-[16px]">
                  <button class="companyEditButton"><span><img alt="" class="w-3 h-3" src="../assets/svg/edit.svg"></span>Edit</button>
                </div>
              </td>
            </tr>
            </tbody>
