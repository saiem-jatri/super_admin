  ...
  <div class="px-[30px] py-[24px]">
    ...
    <div class="bg-white rounded-[10px]">
      <div class="p-4">
        <div class="flex justify-between  divide-x divide-corporateBorder">
          <div class="w-1/2 pr-[60px] xl:pr-[125px]">
            ...
            <button
                class="w-full border border-dashed border-[#1E88E5] flex justify-center items-center bg-[#EFF7FD] rounded-[4px] mt-[12px] xl:mt-[16px]">
              <div class="flex justify-center items-center gap-x-[11px] py-[8px]">
                <img alt="" class="w-[10px] h-[10px]" src="../assets/svg/createPlus.svg">
                <p class="text-primaryText font-[600] leading-[16px] xl:leading-[20px] text-[12px] xl:text-[14px]">Add
                  via city</p>
              </div>
            </button>
      ...
      <div class="px-[16px] py-[20px] w-full flex justify-between items-center">
        ...
        <router-link class="lessOpacityCorporateButton" to="/routesViaCity">Create routes</router-link>
      </div>
    </div>
  </div>
</template>
