              ...
              <div class="w-1/2 pr-[60px] xl:pr-[125px]">
                <div class="flex justify-between items-center">
                  ...
                  <div class="w-[200px] xl:w-[270px]">
                    <Dropdown class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Dhaka" />
                  </div>
                </div>
                <div class="flex justify-between items-center">
                  ...
                  <div class="w-[200px] xl:w-[270px] mb-2">
                    <Dropdown class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Owner" />
                  </div>
                </div>
                <div class="flex justify-between items-center">
                  ...
                  <div class="w-[200px] xl:w-[270px] mb-2">
                    <Dropdown class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Select via city" />
                  </div>
                </div>
                <button class="w-full border border-dashed border-[#1E88E5] flex justify-center items-center bg-[#EFF7FD] rounded-[4px] mt-[6px] xl:mt-[10px]">
              ...
              <div class="w-1/2">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="mt-[8px] xl:mt-[16px] flex items-center gap-x-[8px]">
                    <img src="../assets/svg/bar.svg" class="cursor-grab"  alt="">
