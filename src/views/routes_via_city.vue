                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="w-[200px] xl:w-[270px]">
                    <Dropdown v-model="selectedCity" :options="cities"
                              class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" optionLabel="name" placeholder="Dhaka"/>
                  </div>
                </div>
                <div class="flex justify-between items-center">
                  <label class="leading-[16px] text-[12px] xl:leading-[20px] xl:text-[14px] text-primaryText font-[400]"
                  ...
                  <div class="w-[200px] xl:w-[270px] mb-2">
                    <Dropdown v-model="selectedCity" :options="cities"
                              class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" optionLabel="name" placeholder="Owner"/>
                  </div>
                </div>
                <div class="flex justify-between items-center">
                  <label class="leading-[16px] text-[12px] xl:leading-[20px] xl:text-[14px] text-primaryText font-[400]"
                  ...
                  <div class="w-[200px] xl:w-[270px] mb-2">
                    <Dropdown v-model="selectedCity" :options="cities"
                              class="w-full py-[4px] mt-[10px] placeholder:text-primaryText" optionLabel="name" placeholder="Select via city"/>
                  </div>
                </div>
                <button
              ...
              <div class="w-1/2">
                <div class=" pl-4">
                  ...
                  <div class="mt-[8px] xl:mt-[16px] flex items-center gap-x-[8px]">
                    <img alt="" class="cursor-grab" src="../assets/svg/bar.svg">
