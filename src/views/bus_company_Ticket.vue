          ...
          <div class="flex justify-center items-center gap-x-[32px]">
            ...
            <div class="flex flex-col gap-y-[4px]">
              ...
              <div class="flex justify-center items-center gap-x-[6px]">
                ...
                <p class="text-secondaryText leading-[16px] text-[12px] font-[400]">Desh Travels Limited</p>
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[16px] text-[12px] font-[400]">Manage</p>
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[16px] text-[12px] font-[400]">Ticket</p>
              </div>
            </div>
          </div>
