    ...
    <div class="h-screen w-full overflow-y-auto bg-[#F7F7F7]">
      ...
      <div class="px-[30px] py-[24px]">
        ...
        <div class="bg-white rounded-[8px] mt-[12px] xl:mt-[16px]">
              ...
              <div class="flex justify-between gap-x-[20px] xl:gap-x-[27px]">
                <div class="w-full">
                  <div class="flex justify-between items-center">
                    ...
                    <input type="text" class="w-[120px] border border-corporateBorder rounded-[4px] px-2 py-[6px] focus:outline-none" placeholder="Enter Fare">
          ...
          <div class="p-4">
            <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[500]">BUS INFORMATION & SEAT LAYOUT</p>
