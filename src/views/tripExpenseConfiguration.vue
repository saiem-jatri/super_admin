          ...
          <div class="bg-white rounded">
            <div class="p-4">
                  ...
                  <div class="w-1/4 xl:w-1/5">
                    ...
                    <Dropdown class="w-full py-1 mt-[10px] placeholder:text-primaryText placeholder:leading-[16px] placeholder:text-[12px] xl:placeholder:leading-[20px] xl:placeholder:text-[14px]" v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Select operator" />
                  </div>
                  <div class="flex items-end self-end gap-[10px] hidden">
                ...
                <router-link to="/tripExpenseConfigurationFilled" class="w-full border border-dashed border-corporateSecondaryBlue flex justify-center items-center bg-[#EFF7FD] rounded-[4px]"> 
                ...
                <div class="px-[16px] py-[20px] w-full flex justify-center items-center">
                  <router-link to="/tripExpenseConfigurationFilled" class="lessOpacityCorporateButton">Create expense</router-link>
                </div>
          </div>
        </div>
  </template>
