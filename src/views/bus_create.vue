            ...
            <div class="flex divide-x divide-corporateBorder">
                ...
                <div class="py-[8px] pr-[24px]">
                  ...
                  <div class="flex gap-x-2 mt-4 items-center">
                    <p class="text-primaryText leading-[16px] xl:leading-[20px] text-[12px] xl:text-[14px]">Select
                      row:</p>
                    <div>
                      <Dropdown v-model="selectedCity" :opti6ns="cities" class="w-full py-2"
                                optionLabel="name"
                  ...
                  <div class="flex justify-center items-center mt-4 xl:mt-5">
                    <router-link
                        class="bg-corporate bg-opacity-30 flex gap-x-3 justify-center items-center text-white rounded-full px-6 py-4 mr-4 leading-[12px] text-[10px] xl:leading-[16px] xl:text-[12px] w-1/5"
                        to="/busCreate">
              ...
              <div class="w-1/2">
                <div class="py-2 pl-[16px]">
                  ...
                  <div class="flex gap-x-[30px] xl:gap-x-[50px] items-center mt-4">
                    <p>Ex 2</p>
                    <div class="flex gap-x-[20px] xl:gap-x-[26px] justify-start">
                      <input
                          class="bg-[#EDEDED] w-[40px] xl:w-[50px] h-[26px] xl:h-[36px] focus:outline-none text-center"
                          type="text">
                      <input
                          class="bg-[#EDEDED] w-[40px] xl:w-[50px] h-[26px] xl:h-[36px] focus:outline-none text-center"
                          type="text">
