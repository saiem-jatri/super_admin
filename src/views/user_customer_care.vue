        ...
        <div class="flex justify-between items-center">
          <div class="pl-8 flex flex-col gap-y-2">
            ...
            <div class="flex justify-center items-center gap-x-[6px]">
              ...
              <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">Cuatomer Care</p>
            </div>
          </div>
          <div
          ...
          <div class="flex gap-x-2 p-4 justify-center items-center mr-6 ">
            <router-link to="/userCreateCustomercare" class="topBarAddButton">
              <span><img src="../assets/svg/plus.svg" class="h-[9.33px] w-[9.33px]" alt=""></span>Add customer care
            </router-link>
