      ...
      <div class="px-[30px] py-[24px]">
        ...
        <div class="border-b border-[#EDEDED] gap-x-4">
          <div class="flex justify-start items-center">
            ...
            <a class="block full h-[25px] xl:w-[120px] xl:h-[30px] text-center border-b-4 border-corporate leading-[16px] text-[12px] xl:leading-[20px] xl:text-[14px] rounded-t-[8px] bg-white text-corporate font-[600]"
        ...
        <div class="mt-[16px] bg-white">
          <div class="p-4 flex justify-between items-center">
            ...
            <button
                class="flex gap-x-[9px] justify-center items-center bg-corporate text-white leading-[14px] xl:leading-[16px] text-[11px] xl:text-[12px] font-[500] py-3 px-6 rounded-full mt-6"><span>
