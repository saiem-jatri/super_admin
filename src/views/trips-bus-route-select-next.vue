  ...
  <div class="flex bg-corporateBg" :class=" seatSelectStatus ? 'before:bg-black before:bg-opacity-40 before:transition-opacity before:w-full before:h-full before:absolute before:top-0 before:l-0 before:z-50' : ''">
    <div class="h-screen w-full overflow-y-auto bg-[#F7F7F7]">
      ...
      <div class="px-[30px] py-[24px]">
        ...
        <div class="bg-white rounded-[10px] mt-[12px] xl:mt-[16px]">
          ...
          <div class="p-4">
                <div class="flex gap-x-[197px]">
                  ...
                  <div class="mt-[74px]">
                    <button class="w-full border border-dashed border-corporateSecondaryBlue flex justify-center items-center bg-[#EFF7FD] rounded-[4px] mb-[18px]">
                    ...
                    <button class="w-full border border-dashed border-corporateSecondaryBlue flex justify-center items-center bg-[#EFF7FD] rounded-[4px] mt-[18px]">
                      <div class="flex justify-center items-center gap-x-[11px] py-[12px]">
                        <img src="../assets/svg/createPlus.svg" class="w-[10px] h-[10px]" alt="">
                        <p class="text-primaryText font-[600] leading-[20px] text-[14px]">Add seats</p>
                      </div>
        ...
        <div class="flex justify-center items-center gap-x-6 my-5">
        ...
        <div class="p-4 flex justify-between items-center">
          ...
          <div>
            <button @click="openModal" class="border border-corporateBorder items-center text-corporateError font-[600] rounded-full px-6 py-3 leading-[12px] text-[10px] xl:leading-[16px] xl:text-[12px]">
            Cancel trip
            </button>
