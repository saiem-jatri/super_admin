      ...
      <div class="bg-white rounded-[8px] mt-[12px] xl:mt-[16px]">
        <div class="p-4">
          ...
          <div class="mt-3 xl:mt-4 flex gap-x-4 justify-start items-center">
            <div class="flex justify-between min-w-[200px] border border-corporateBorder rounded-[4px] px-2 py-[6px]">
                <span>Buffet</span>
                <span><img src="../assets/svg/close-cirlce.svg" alt=""></span>
            </div>
            ...
            <button
                class="bg-[#EFF7FD] flex gap-x-[11px] justify-center items-center border border-dashed border-[#1E88E5] px-4 py-[6px] rounded-[4px]">
            ...
            <table class="min-w-full">
              ...
              <tr class="bg-corporateBg border-l border-r border-corporateBorder">
                ...
                <td class="text-4 text-center leading-6 p-[16px]">
                  <div class="form-group mb-0"><input id="read1" type="checkbox" checked><label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                                                                                       for="read1"></label>
                  </div>
                </td>
              </tr>
              <tr class="border-l border-r border-corporateBorder">
                <td class="border-r border-[#EDEDED] text-4 text-center leading-6 p-[16px]">18 July 2022</td>
                <td class="text-4 text-center leading-6 p-[16px]">
                  <div class="form-group mb-0"><input id="read2" type="checkbox" checked><label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                                                                                       for="read2"></label>
                  </div>
                </td>
              </tr>
              <tr class="bg-corporateBg border-l border-r border-corporateBorder">
                <td class="border-r border-[#EDEDED] text-4 text-center leading-6 p-[16px]">18 July 2022</td>
                <td class="text-4 text-center leading-6 p-[16px]">
                  <div class="form-group mb-0"><input id="read3" type="checkbox" checked><label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                                                                                       for="read3"></label>
                  </div>
                </td>
              </tr>
