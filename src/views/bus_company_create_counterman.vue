      ...
      <div class="px-[30px] py-[24px]">
        ...
        <div class="mt-[16px] bg-white rounded-[10px]">
          <div class="p-4">
            ...
            <div class="flex justify-center items-center gap-x-[10px] xl:gap-x-[16px] mt-[12px] xl:mt-[16px]">
              <div class="w-1/4">
                ...
                <Dropdown class="w-full py-[7px] mt-[10px]" v-model="selectedCity" :opti6ns="cities" optionLabel="name" placeholder="Select counter city" />
              </div>
              <div class="w-1/4">
          ...
          <div class="flex justify-between items-center w-full">
             <p class="text-primaryText leading-[24px] xl:leading-[28px] text-[18px] xl:text-[20px] font-[600] text-center">Permissions</p>
                ...
                <div class="flex divide-x divide-corporateBorder">
                  <div class="w-1/2">
                    <div class="py-[8px] pr-[24px]">
                      <div class="flex justify-between items-center">
                        <p class="w-[60%] leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px]">Ticket Booking:</p>

                        <div class="form-group mt-2 w-[40%] flex justify-end">
                      ...
                      <hr class="border-t border-dashed border-corporateBorder">
                      <div class="flex justify-between items-center">
                        <p class="w-[50%] xl:w-[60%] leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px]">Seats:</p>
                        <div class="flex justify-end items-center gap-x-[24px] w-[50%] xl:w-[40%] mr-4">
                  ...
                  <div class="w-1/2">
                    <div class="py-2 pl-[16px]">
                      <div class="flex justify-between items-center">
                        <p class="w-[60%] leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px]">Fare Discount:</p>
                      ...
                      <hr class="border-t border-dashed border-corporateBorder">
                      <div class="flex justify-between items-center">
                        <p class="w-[60%] leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px]">SMS:</p>
          ...
          <div class="px-[16px] py-[20px] w-full flex justify-between items-center">
            ...
            <button class="flex justify-center items-center text-white leading-[16px] text-[12px] xl:leading-[20px] xl:text-[14px] font-[600] bg-corporate bg-opacity-30 rounded-full px-[20px] py-[11px] xl:px-[24px] xl:py-[13px]">Create counterman</button>
          </div>
        </div>
      </div>
    </div>
