<template>
  <div :class=" seatSelectStatus ? 'before:bg-black before:bg-opacity-40 before:transition-opacity before:w-full before:h-full before:absolute before:top-0 before:l-0 before:z-50' : ''"
       class="flex bg-corporateBg">
    <div class="h-screen w-full overflow-y-auto bg-[#F7F7F7]">
      ...
      <div class="px-[30px] py-[24px]">
          ...
          <div class="p-4">
            <div class="flex items-center gap-x-[6px] mr-2">
              ...
              <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">
                Boarding & Dropping</p>
              <img alt="" class="w-1 h-2" src="../assets/svg/bgBack.svg">
              <p class="text-primaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[600]">Seat &
                Fare</p>
              <img alt="" class="w-1 h-2" src="../assets/svg/bgBack.svg">
              <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">
            ...
            <div class="flex justify-between items-center">
              <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[600] mt-2">SEAT
                & FARE</p>
        ...
        <div class="bg-white rounded-[10px] mt-[12px] xl:mt-[16px]">
          <div class="p-4">
            <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[600]">TICKET
              FARE</p>
            <div class="w-1/4 mt-3 xl:mt-4">
              ...
              <Dropdown v-model="selectedCity" :opti6ns="cities" class="w-full py-[4px] mt-[10px]" optionLabel="name"
                        placeholder="Dhaka-Tangail-Bogura-Rangpur"/>
            </div>
            ...
            <div class="w-[70%] mt-3 xl:mt-4">
              <div class="flex justify-between gap-x-[20px] xl:gap-x-[27px]">
                <div class="w-full">
                  <div class="flex justify-between items-center">
                    <label class="leading-[16px] xl:leading-[24px] text-[12px] xl:text-[16px] mt-4 min-w-[123px]"
                           for="#">Dhaka
                      - Tangail:</label>
                    <div class="flex gap-x-4 justify-start">
                      <div class="xl:ml-4">
                        <p class="leading-[16px] xl:leading-[20px] text-[12px] xl:text-[14px] font-[400]">Economy</p>
                        <input class="w-[120px] border border-corporateBorder rounded-[4px] px-2 py-[6px] focus:outline-none mt-2"
              ...
              <div class="flex justify-between gap-x-[20px] xl:gap-x-[27px]">
                <div class="w-full">
                  <div class="flex justify-between items-center mt-1">
                    <label class="leading-[16px] xl:leading-[24px] text-[12px] xl:text-[16px] min-w-[123px]" for="#">Dhaka
                      - Tangail:</label>
                    <div class="xl:ml-4">
                      <input class="w-[120px] border border-corporateBorder rounded-[4px] px-2 py-[6px] focus:outline-none mt-1"
                             placeholder="Enter Fare"
                             type="text">
                    </div>
                    <div class="flex gap-x-[8px] xl:gap-x-[19px]">
                      <div class="form-group mb-0">
                        <input id="read4" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read4">
                          Jatri</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read5" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read5">
                          Counter</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read6" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read6">
                          Agent</label>
                      </div>
              ...
              <div class="flex justify-between gap-x-[20px] xl:gap-x-[27px]">
                <div class="w-full">
                  <div class="flex justify-between items-center mt-1">
                    ...
                    <div class="flex gap-x-[8px] xl:gap-x-[19px]">
                      <div class="form-group mb-0">
                        <input id="read" type="checkbox7">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read">
                          Jatri</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read" type="checkbox8">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read">
                          Counter</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read" type="checkbox9">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read">
                          Agent</label>
                      </div>
              ...
              <div class="flex justify-between gap-x-[20px] xl:gap-x-[27px]">
                <div class="w-full">
                  <div class="flex justify-between items-center mt-1">
                    ...
                    <div class="flex gap-x-[8px] xl:gap-x-[19px]">
                      <div class="form-group mb-0">
                        <input id="read10" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read10">
                          Jatri</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read11" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read11">
                          Counter</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read12" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read12">
                          Agent</label>
                      </div>
              ...
              <div class="flex justify-between gap-x-[20px] xl:gap-x-[27px]">
                <div class="w-full">
                  <div class="flex justify-between items-center mt-1">
                    ...
                    <div class="flex gap-x-[8px] xl:gap-x-[19px]">
                      <div class="form-group mb-0">
                        <input id="read13" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read13">
                          Jatri</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read14" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read14">
                          Counter</label>
                      </div>
                      <div class="form-group mb-0">
                        <input id="read15" type="checkbox">
                        <label class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                               for="read15">
                          Agent</label>
                      </div>
          ...
          <div class="p-4">
            <div class="">
              <div class="flex gap-x-[197px]">
                <div>
                  <p class="text-[#1E88E5] leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] font-[600]">BUS
                    INFORMATION & SEAT LAYOUT FARE</p>
                  <p class="leading-[20px] xl:leading-[24px] text-[14px] xl:text-[16px] text-primaryText font-[600] mt-3 xl:mt-4">
                    Bus model</p>
                  <select id="model" class="px-3 py-2 border border-corporateBorder rounded-[4px] focus:outline-none mt-[10px] w-full"
                          name="model">
                  ...
                  <div class="mt-[12px] xl:mt-[14px] bg-[#F1F9F1] rounded-[4px] py-[4px] px-[8px]">
                    <p class="leading-[12px] xl:leading-[16px] text-[10px] xl:text-[12px] text-primaryText">Bus type &
                      class</p>
                    <p class="leading-[12px] xl:leading-[16px] text-[10px] xl:text-[12px] text-primaryText font-[600] mt-1">
                      AC, Mixed Class</p>
                  </div>
                </div>

                <div class="mt-[74px]">
                  <div :class=" seatSelectStatus ? 'transform scale-[1.2]' : 'transform scale-100'"
                       class="flex items-center gap-x-[22px] relative z-[100000]">
                    <div :class="seatSelectStatus ? 'z-[100000]': '' " class="flex gap-x-[15px] xl:gap-x-[20px]">
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">EX1
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">EX2
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative hidden">EX
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">EX3
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">EX4
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                    </div>
                    <button :class="seatSelectStatus ? 'hidden' : 'absolute right-[-40px]'" @click="extraSeat">
                      <img alt="Close" src="../assets/svg/close-cirlce.svg">
                    </button>
                  </div>
                  ...
                  <div class="flex gap-x-[15px] xl:gap-x-[20px] mt-[20px] xl:mt-[24px]">
                    ...
                    <button class="seatButton hidden">H1</button>
                  ...
                  <div class="flex gap-x-[15px] xl:gap-x-[20px] mt-[20px] xl:mt-[24px]">
                    ...
                    <button class="seatButton hidden">I1</button>
                    <button class="seatButton">I3</button>
                    <button class="seatButton">I4</button>
                  </div>

                  <div :class=" seatSelectStatus ? 'transform scale-[1.2]' : 'transform scale-100'"
                       class="flex items-center gap-x-[22px] mt-[20px] xl:mt-[24px] relative z-[100000]">
                    <div :class="seatSelectStatus ? 'z-[100000]': '' " class="flex gap-x-[15px] xl:gap-x-[20px]">
                      <button :class=" seatSelectStatus ? 'noSeatButton' : 'lockSeatButton'" class="relative">
                        <img alt="Lock" class="m-auto" src="../assets/svg/lock.svg">
                        <img :class=" seatSelectStatus ? 'opacity-100 hidden' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">J2
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative hidden">J
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">J3
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">J4
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                  ...
                  <div :class=" seatSelectStatus ? 'transform scale-[1.2]' : 'transform scale-100'"
                       class="flex items-center gap-x-[22px] mt-[20px] xl:mt-[24px] relative z-[100000]">
                    <div :class="seatSelectStatus ? 'z-[100000]': '' " class="flex gap-x-[15px] xl:gap-x-[20px]">
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">K1
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">K2
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative hidden">K
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">K3
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                      <button :class=" seatSelectStatus ? 'whiteSeatButton' : 'seatButton'" class="relative">K4
                        <img :class=" seatSelectStatus ? 'opacity-100' : 'seatButton'" alt="Close"
                             class="absolute top-[-6px] right-[-6px] opacity-0"
                             src="../assets/svg/bg_close.svg">
                      </button>
                  ...
                  <div class="flex justify-center z-[10000] relative">
                    <button :class="seatSelectStatus ? '' : 'hidden'"
                            class="bg-white flex gap-x-3 justify-center items-center text-[#48A43F] rounded-full px-5 py-3 leading-[12px] text-[10px] xl:leading-[16px] xl:text-[12px] mt-5"
                            data-v-0d08c475="" @click="extraSeat">
                      <span data-v-0d08c475=""><img alt="" data-v-0d08c475="" src="../assets/svg/green-save.svg"></span>
                      Save changes
                    </button>
                  </div>
                </div>
        ...
        <div class="bg-white rounded-[8px] mt-4">
          <div class="p-4">
            ...
            <!-- table start -->
            <div class="rounded-[10px] border border-[#EDEDED] mt-4 overflow-hidden">
              <table class="min-w-full">
                <thead>
                <tr>
                  <th class="border-r border-[#EDEDED] text-4 leading-6 font-[400] p-[10px] uppercase w-1/2"
                      scope="col"> DATE
                  </th>
                  <th class="text-4 leading-6 font-[400] p-[10px] uppercase flex items-center justify-center gap-x-5"
                      scope="col"><span>Check for all</span> <span><div class="form-group mb-0"><input
                ...
                <tbody>
                <tr>
                  <td class="border-r border-[#EDEDED] text-4 text-center leading-6 p-[16px] bg-[#F7F7F7]">18 July
                    2022
                  </td>
                  <td class="text-4 text-center leading-6 p-[16px] bg-[#F7F7F7]">
                    <div class="form-group mb-0"><input id="read1" checked type="checkbox"><label
                        class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                        for="read1"></label>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="text-4 text-center leading-6 p-[16px]">
                    <div class="form-group mb-0"><input id="read2" checked type="checkbox"><label
                        class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                        for="read2"></label>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="text-4 text-center leading-6 p-[16px] bg-[#F7F7F7]">
                    <div class="form-group mb-0"><input id="read3" checked type="checkbox"><label
                        class="text-primaryText leading-[16px] text-[10px] xl:leading-[20px] xl:text-[14px] font-[400]"
                        for="read3"></label>
                    </div>
                  </td>
        ...
        <div class="flex justify-center items-center gap-x-4 my-5">
          <button
              class="bg-[#48A43F] flex gap-x-3 justify-center items-center text-white rounded-full px-5 py-3 leading-[12px] text-[10px] xl:leading-[16px] xl:text-[12px]"
              data-v-0d08c475="">
            <span data-v-0d08c475=""><img alt="" data-v-0d08c475="" src="/src/assets/svg/save.svg"></span> Save changes
          </button>
          <router-link class="nextStepButton flex items-center gap-[10px]" to="/tripsPermission">
        ...
        <div class="bg-white rounded-[8px]">
          <div class="p-4 flex justify-between items-center">
            <div>
              <p class="text-primaryText leading-[28px] text-[20px] xl:leading-[32px] xl:text-[24px] font-[600] mb-[8px]">
                Cancel trip</p>
              <p class="text-primaryText ">By clicking “Cancel trip”, it will cancel the trip and the tickets in the
                trip. This action could not be undone.</p>
            </div>
            <div>
              <button class="border border-corporateBorder items-center text-corporateError rounded-full px-6 py-3 font-semibold leading-[12px] text-[10px] xl:leading-[16px] xl:text-[12px]"
                      @click="openModal">
                Cancel trip
              </button>
              <Dialog v-model:visible="displayModal" :breakpoints="{'960px': '75vw', '640px': '90vw'}"
                      :modal="true" :style="{width: '360px'}" header="Cancel Trip">
                <p class="text-[14px] leading-5 text-[#4D4D4F] text-center">By confirming, the trip will be cancelled
                  and all its ticket. You will not be able to perform any action in this trip further. Are you sure you
                  want to cancel the trip?</p>
                <div class="mt-[30px] flex gap-x-8 justify-end items-center">
                  ...
                  <button autofocus class="bg-[#F04935] px-6 py-3 text-white text-[12px] leading-4 font-[500] rounded-[100px]" icon="pi pi-check"
                          @click="closeModal">
                    Cancel trip
                  </button>
                </div>
