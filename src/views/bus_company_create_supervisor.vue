        ...
        <div class="flex justify-between">
          <div class="flex justify-center items-center gap-x-[32px]">
            ...
            <div class="flex flex-col gap-y-[4px]">
              <p class="lg:leading-[16px] xl:leading-[28px] lg:text-[14px] xl:text-[20px] font-[600] text-primaryText">Create Supervisor</p>
              <div class="flex justify-center items-center gap-x-[6px]">
                ...
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">Staffs</p>
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">Supervisor</p>
                <img src="../assets/svg/bgBack.svg" alt="" class="w-1 h-2">
                <p class="text-secondaryText leading-[12px] text-[8px] xl:leading-[16px] xl:text-[12px] font-[400]">Add supervisor</p>
              </div>
            </div>
          </div>
          <div class="flex justify-end items-center gap-x-1 p-4 w-1/2">
        ...
        <div class="bg-white rounded-[10px]">
          <div class="p-4">
            <div class="flex justify-center items-center gap-x-[10px] xl:gap-x-[16px]">
              <div class="w-1/4">
                <p class="text-primaryText leading-[20px] text-[12px] xl:leading-[24px] xl:text-[16px] font-[600]">Supervisor name</p>
                <input type="text" class="createNormalInput" placeholder="Enter supervisor name">
              </div>
              <div class="w-1/4">
            ...
            <div class="flex justify-start items-center mt-[12px] xl:mt-[16px]">
          ...
          <hr class="mborder-t border-corporateBorder">
          <div class="px-[16px] py-[20px] w-full flex justify-between items-center">
            ...
            <div class="flex gap-x-2 items-center">
                <button class="corporateButton">Create supervisor</button>
